...
public class MainFrame extends JFrame {
	...
	public MainFrame() {
		...
		btnLoad.setBounds(61, 77, 64, 23);
		panel.add(btnLoad);
		
		JButton btnSave = new JButton("Save");
		btnSave.setBounds(164, 77, 64, 23);
		panel.add(btnSave);
		...
		btnNewButton_1.setBounds(173, 12, 52, 23);
		panel_1.add(btnNewButton_1);
		
		JButton btnCos = new JButton("Cos");
		btnCos.setBounds(173, 48, 52, 23);
		panel_1.add(btnCos);
		
		JButton btnTan = new JButton("tan");
		btnTan.setBounds(173, 84, 52, 23);
		panel_1.add(btnTan);
		...
		button_17.setBounds(173, 120, 52, 23);
		panel_1.add(button_17);
		
		JButton btnX = new JButton("X");
		btnX.setBounds(10, 172, 41, 25);
		panel_1.add(btnX);
		
		JButton btnA = new JButton("A");
		btnA.setBounds(10, 208, 41, 25);
		panel_1.add(btnA);
		
		JButton btnY = new JButton("Y");
		btnY.setBounds(61, 173, 41, 25);
		panel_1.add(btnY);
		
		JButton btnB = new JButton("B");
		btnB.setBounds(61, 209, 41, 25);
		panel_1.add(btnB);
		
		JButton btnZ = new JButton("Z");
		btnZ.setBounds(112, 173, 41, 25);
		panel_1.add(btnZ);
		
		JButton btnC = new JButton("C");
		btnC.setBounds(112, 209, 41, 25);
		panel_1.add(btnC);
		
		JButton btnI = new JButton("I");
		btnI.setBounds(184, 172, 41, 25);
		panel_1.add(btnI);
		
		JButton btnJ = new JButton("J");
		btnJ.setBounds(235, 172, 41, 25);
		panel_1.add(btnJ);
		
		JButton btnK = new JButton("K");
		btnK.setBounds(286, 172, 41, 25);
		panel_1.add(btnK);
		...
		btnL.setBounds(184, 209, 41, 25);
		panel_1.add(btnL);
		
		JButton btnM = new JButton("M");
		btnM.setBounds(235, 209, 41, 25);
		panel_1.add(btnM);
		
		JButton btnN = new JButton("N");
		btnN.setBounds(286, 209, 41, 25);
		panel_1.add(btnN);
		
		JPanel panel_2 = new JPanel();
		panel_2.setBounds(357, 11, 280, 112);
		panel_2.setName("");
		...
		btnNew.setBounds(181, 7, 89, 23);
		panel_2.add(btnNew);
		
		JButton btnUse = new JButton("Use");
		btnUse.setBounds(181, 41, 89, 23);
		panel_2.add(btnUse);
		
		JButton btnEdit = new JButton("Edit");
		btnEdit.setBounds(181, 75, 89, 23);
		panel_2.add(btnEdit);
		
		JPanel panel_3 = new JPanel();
		panel_3.setBounds(357, 238, 280, 243);
		panel_3.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
		contentPane.add(panel_3);
		panel_3.setLayout(null);
		
		JLabel lblX = new JLabel("X = ");
		lblX.setBounds(10, 11, 29, 14);
		panel_3.add(lblX);
		
		textField_2 = new JTextField();
		textField_2.setBounds(32, 8, 45, 20);
		panel_3.add(textField_2);
		textField_2.setColumns(10);
		
		JLabel lblY = new JLabel("Y = ");
		lblY.setBounds(10, 50, 29, 14);
		panel_3.add(lblY);
		
		textField_3 = new JTextField();
		textField_3.setBounds(32, 47, 45, 20);
		panel_3.add(textField_3);
		textField_3.setColumns(10);
		
		JLabel lblZ = new JLabel("Z = ");
		lblZ.setBounds(10, 86, 29, 14);
		panel_3.add(lblZ);
		
		textField_4 = new JTextField();
		textField_4.setColumns(10);
		textField_4.setBounds(32, 83, 45, 20);
		panel_3.add(textField_4);
		
		JLabel lblA = new JLabel("A = ");
		lblA.setBounds(10, 137, 29, 14);
		panel_3.add(lblA);
		
		textField_5 = new JTextField();
		textField_5.setColumns(10);
		textField_5.setBounds(32, 134, 45, 20);
		panel_3.add(textField_5);
		
		JLabel lblC = new JLabel("C =");
		lblC.setBounds(10, 218, 46, 14);
		panel_3.add(lblC);
		
		textField_6 = new JTextField();
		textField_6.setColumns(10);
		textField_6.setBounds(32, 212, 45, 20);
		panel_3.add(textField_6);
		
		textField_7 = new JTextField();
		textField_7.setColumns(10);
		textField_7.setBounds(32, 174, 45, 20);
		panel_3.add(textField_7);
		
		JLabel lblB = new JLabel("B =");
		lblB.setBounds(10, 177, 46, 14);
		panel_3.add(lblB);
		
		JLabel lblI = new JLabel("I = ");
		lblI.setBounds(143, 11, 29, 14);
		panel_3.add(lblI);
		
		textField_8 = new JTextField();
		textField_8.setColumns(10);
		textField_8.setBounds(169, 8, 45, 20);
		panel_3.add(textField_8);
		
		textField_9 = new JTextField();
		textField_9.setColumns(10);
		textField_9.setBounds(169, 47, 45, 20);
		panel_3.add(textField_9);
		
		textField_10 = new JTextField();
		textField_10.setColumns(10);
		textField_10.setBounds(169, 83, 45, 20);
		panel_3.add(textField_10);
		
		textField_11 = new JTextField();
		textField_11.setColumns(10);
		textField_11.setBounds(169, 134, 45, 20);
		panel_3.add(textField_11);
		
		textField_12 = new JTextField();
		textField_12.setColumns(10);
		textField_12.setBounds(169, 174, 45, 20);
		panel_3.add(textField_12);
		
		textField_13 = new JTextField();
		textField_13.setColumns(10);
		textField_13.setBounds(169, 212, 45, 20);
		panel_3.add(textField_13);
		
		JLabel lblJ = new JLabel("J = ");
		lblJ.setBounds(143, 50, 29, 14);
		panel_3.add(lblJ);
		
		JLabel lblK = new JLabel("K = ");
		lblK.setBounds(143, 86, 29, 14);
		panel_3.add(lblK);
		
		JLabel lblL = new JLabel("L = ");
		lblL.setBounds(143, 137, 29, 14);
		panel_3.add(lblL);
		
		JLabel lblM = new JLabel("M = ");
		lblM.setBounds(143, 177, 29, 14);
		panel_3.add(lblM);
		
		JLabel lblN = new JLabel("N = ");
		lblN.setBounds(143, 218, 29, 14);
		panel_3.add(lblN);
		
		JPanel panel_4 = new JPanel();
		panel_4.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
		panel_4.setBounds(10, 134, 337, 93);
